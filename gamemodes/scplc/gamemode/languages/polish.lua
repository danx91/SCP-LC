...
lang.NRegistry = {
    ...
    rxpspec = "Otrzymaliście %i doświadczenie za gre na tym serwerze!",
    rxpplay = "Otrzymaliście %i doświadczenie za pozostanie przy życiu w rundzie!",
    rxpplus = "Otrzymaliście %i doświadczenie za przetrwanie ponad połowy rundy!",
    roundxp = "Otrzymaliście %i doświadczenie za swoje punkty",
