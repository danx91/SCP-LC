...
lang.NRegistry = {
	...
	dailybonus = "Оставшийся ежедневный бонус: %i ОО\nСледующий сброс через: %s"
}
...
main_menu.precache = "Прекэш моделей"
main_menu.credits = "Авторы"
main_menu.quit = "Выход"

main_menu.quit_server = "Выйти с сервера?"
main_menu.quit_server_confirmation = "Вы уверены?"
main_menu.model_precache = "Прекэш моделей"
main_menu.model_precache_text = "Модели прекэшируются автоматически, когда это необходимо, но это происходит во время игры, поэтому может вызвать зависание игры. Чтобы избежать этого, вы можете предварительно кэшировать их сейчас вручную.\nВо время этого процесса игра может зависнуть!"
main_menu.yes = "Да"
main_menu.no = "Нет"
main_menu.all = "Прекэшировать модели"
...
lang.XP_BAR = {
	general = "Общий опыт",
	round = "Оставаясь на этом сервере",
	escape = "Побег с комплекса",
	score = "Очки, заработанные во время раунда",
	win = "Победа в раунде",
	vip = "VIP-бонус",
	daily = "Ежедневный бонус",
	cmd = "Божественная сила",
}
...
lang.refounded = "Все удалённые классы были возвращены. Вы получили %d очков класса."
...
lang.settings = {
	...
	binds = {
		...
		scp_special = "Особые возможности SCP"
	},

	config = {
		search_indicator = "Индикатор поиска",
		scp_hud_skill_time = "Время перезарядки способностей SCP",
		smooth_blink = "Плавное моргание",
		scp_hud_overload_cd = "Показать время перезарядки перегрузки",
...
misc.placing_turret = "Установка турели"
misc.scanning = "СКАНИРОВАНИЕ"
--[[-------------------------------------------------------------------------
Vests
---------------------------------------------------------------------------]]
local vest = {}
...
Описание:
Если кто-то вас увидит, то они попадут в ваш список. Из раза в раз вы телепортируетесь по людям в списке и сжигаете их дотла. Вы можете создавать клона.
]],
