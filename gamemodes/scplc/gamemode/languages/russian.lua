...
wep.SCP058 = {
	skills = {
		primary_attack = {
			name = "Основная атака",
			dsc = "Атакует своим жалом прямо перед собой. Применяет яд, если куплено соответственное улучшение."
		},
		shot = {
			name = "Выстрел",
			dsc = "Выстреливает снаряд в направлении вашей цели. Снаряд будет двигаться по баллистической кривой. Улучшения, связанные с выстрелом, влияют на время ожидания, скорость, размер и эффекты этой способности."
		},
		shot_stacks = {
			name = "Стеки выстрелов",
			dsc = "Показывает накопленное количество выстрелов. Различные улучшения, связанные с выстрелами, влияют на максимальное количество и время перезарядки."
		},
	},
	...
	upgrades = {
		...
		shot32 = {
			...
			info = "Увеличивает максимальное количество выстрелов и увеличивает скорострельность.\n\t• Количество выстрелов уменьшено в [stacks]\n\t• Выстрелы восстанавливаются со скоростью в [regen_rate] ед.\n\t• Множитель размера снаряда: [shot_size]\n\t• Множитель скорости снаряда: [shot_speed]"
		},
		exp1 = {
			name = "Разрыв аорты",
			info = "Открывает возможность взорваться, наносит большой урон, но при каждом взрыве количество здоровья уменьшается на 1000 ОЗ"
		},
		exp2 = {
