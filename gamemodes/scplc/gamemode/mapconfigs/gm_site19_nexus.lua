...
MAP_ZONES = {
	...
	[ZONE_HCZ] = {
		{ Vector( 3250, -3000, -600 ), Vector( 6500, 4000, 500 ) },
		{ Vector( 1900, 1440, -1000 ), Vector( 3250, 2100, 500 ) },
		{ Vector( 2176, 2100, -500 ), Vector( 3250, 2650, 500 ) },
		{ Vector( 1536, 2650, -500 ), Vector( 3250, 3912, 500 ) },
