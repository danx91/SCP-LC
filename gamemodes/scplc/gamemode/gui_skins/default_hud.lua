...
AddGUISkin( "pre_hud", "default", pre )
AddGUISkin( "spectator_hud", "default", spec_hud )
AddGUISkin( "hud", "default", hud )
AddGUISkin( "additional_hud", "default", a_hud )
AddGUISkin( "post_hud", "default", post )